...
// BTRatingView
#define COCOAPODS_POD_AVAILABLE_BTRatingView
#define COCOAPODS_VERSION_MAJOR_BTRatingView 1
#define COCOAPODS_VERSION_MINOR_BTRatingView 0
#define COCOAPODS_VERSION_PATCH_BTRatingView 1
